...
private:
    ...
    void setupUI() {
        ...
        connect(loginNightModeButton, &QPushButton::clicked, this, &TicTacToe::toggleNightMode);
        ...
        connect(backButtonDiff, &QPushButton::clicked, this, &TicTacToe::backToModeSelection);
        ...
        nameInputSubtitle->setAlignment(Qt::AlignCenter);
        ...
        startGameButton->setFont(QFont("Arial", 16, QFont::Bold));
        ...
        connect(backButtonName, &QPushButton::clicked, this, &TicTacToe::backToModeSelection);

        QPushButton *nameNightModeButton = new QPushButton("Night Mode", this);
        nameNightModeButton->setMaximumWidth(100);
        connect(nameNightModeButton, &QPushButton::clicked, this, &TicTacToe::toggleNightMode);
        ...
        applySettingsButton->setFont(QFont("Arial", 16, QFont::Bold));
        ...
        connect(backButtonSettings, &QPushButton::clicked, this, &TicTacToe::backToModeSelection);

        QPushButton *settingsNightModeButton = new QPushButton("Night Mode", this);
        settingsNightModeButton->setMaximumWidth(100);
        connect(settingsNightModeButton, &QPushButton::clicked, this, &TicTacToe::toggleNightMode);
