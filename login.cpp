...
void TicTacToe::backToModeSelection() {
    // FIXED: Restore original game state if coming from replay
    if (inReplayMode) {
...
void TicTacToe::loadRecordedMatch() {
    ...
    // FIXED: Store original game state to restore later
    QString originalLoggedInUser = loggedInUser;
    int originalPlayer1Wins = player1Wins;
    int originalPlayer2Wins = player2Wins;
    int originalTies = ties;
    char originalCurrentPlayer = currentPlayer;
    ...
    // FIXED: Store original state for restoration
    this->originalGameState = {
        originalLoggedInUser,
        originalPlayer1Wins,
        originalPlayer2Wins,
        originalTies,
