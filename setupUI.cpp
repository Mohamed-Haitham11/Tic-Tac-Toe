...
void TicTacToe::setupUI() {
    ...
    themeSelector->addItems({"Light", "Dark", "Blue", "Plywood","Byzantine Empire", "S.P.Q.R", "Carthago", "Frosted Glass", "Ancient Egypt", "Seljuk Empire","8-Bit","Cyber Enhanced","Neon Synthwave","Matrix Code","Windows 7 Chess Titans","Chess Titans Classic Wood","Chess Titans Crystal","Chess Titans Silver Elegance","Chess Titans Onyx & Ivory","Chess Titans Silver Steel","Chess Titans Obsidian Onyx"});
    //themeSelector->setCurrentText("Chess Titans Obsidian Onyx");
