...
void TicTacToe::setupUI() {
    ...
    themeSelector->addItems({"Light", "Dark", "Blue", "Plywood", "S.P.Q.R", "Carthago", "Frosted Glass", "Ancient Egypt", "Seljuk Empire","8-Bit","Cyber Enhanced","IGI Tactical","Windows 7 Chess Titans","Chess Titans Classic Wood","Chess Titans Marble Luxury","Chess Titans Crystal","Chess Titans Medieval"});
